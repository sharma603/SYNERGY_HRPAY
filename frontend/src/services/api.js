...
export const costAllocationAPI = {
  ...
  synHRM_Cost_Allocation_Report: (filters) => apiClient.post('/reports/cost-allocation', filters),
  synHRM_Cost_Allocation_Report_Export: (filters) => apiClient.get('/reports/cost-allocation/export', { params: filters }),
